...
public class EmailService {
    ...
    private String generateVerificationEmailText(String token) {
        return "<!doctype html>\n" +
                ...
                "                    <span class=\"apple-link\">Spring Boot Market</span>\n" +
                "                    <br> Don't like these emails? <a href=\"http://localhost:8080/\">Unsubscribe</a>.\n" +
                "                  </td>\n" +
                "                </tr>\n" +
                "                <tr>\n" +
                "                  <td class=\"content-block powered-by\">\n" +
                "                    Powered by <a href=\"http://gb.ru\">GeekBrains</a>.\n" +
                "                  </td>\n" +
                "                </tr>\n" +
                "              </table>\n" +
                "            </div>\n" +
